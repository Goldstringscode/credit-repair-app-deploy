...
export async function PAUSE(request: NextRequest, { params }: { params: { id: string } }) {
    ...
    withValidation(
      async (request: NextRequest, { params }: { params: { id: string } }) => {
        try {
          ...
          const subscription = await subscriptionManager.pauseSubscription(
            subscriptionId,
            {
              pauseUntil: validatedData.pauseUntil,
...
export async function RESUME(request: NextRequest, { params }: { params: { id: string } }) {
  return withRateLimit(
    async (request: NextRequest, { params }: { params: { id: string } }) => {
      try {
        const subscriptionId = params.id
        ...
        const subscription = await subscriptionManager.resumeSubscription(subscriptionId)
