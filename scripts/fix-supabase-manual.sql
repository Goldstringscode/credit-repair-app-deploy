-- Manual Fix for Supabase Functions
-- Run this directly in your Supabase SQL Editor

-- The issue is that the functions are trying to access u.first_name and u.last_name
-- which don't exist in the standard Supabase auth.users table.
-- We need to use u.raw_user_meta_data->>'full_name' or u.email instead.
