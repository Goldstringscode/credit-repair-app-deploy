-- MLM Communication System Test Data - SIMPLE VERSION
...
('gggggggg-gggg-gggg-gggg-gggggggggggg'::uuid, 'Beta Builders - Growth', 'Growth strategies and tactics', 'team', 'team', '22222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', true, '{"growth_focused": true}')
ON CONFLICT (id) DO NOTHING;
...
('gggggggg-gggg-gggg-gggg-gggggggggggg', '22222222-2222-2222-2222-222222222222', 'admin', '{"mentions": true, "all_messages": true, "achievements": true, "announcements": true}')
