...
-- This script fixes the get_user_channels and get_channel_messages functions
-- to work with the correct Supabase auth.users table structure

-- Fix get_channel_messages function
...
-- Fix get_user_channels function
