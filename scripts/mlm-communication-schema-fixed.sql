-- MLM Communication & Messaging System Database Schema - FIXED VERSION
-- This version creates the mlm_users table first, then the communication tables
...
-- First, create a system user if no MLM users exist
...
SELECT 
    ...
    0,
    0
WHERE NOT EXISTS (SELECT 1 FROM mlm_users LIMIT 1);
...
('Welcome New Team Member', 'welcome', 'onboarding', 'Welcome to the team, {{member_name}}! 🎉 We''re excited to have you join our {{team_name}} family. Your sponsor {{sponsor_name}} will be your guide as you start your journey.', '["member_name", "team_name", "sponsor_name"]', '00000000-0000-0000-0000-000000000000', true),

('Achievement Celebration', 'achievement', 'recognition', '🎊 Congratulations {{member_name}}! You''ve just achieved {{achievement_name}}! This is a huge milestone and we''re all proud of your dedication and hard work. Keep up the amazing work!', '["member_name", "achievement_name"]', '00000000-0000-0000-0000-000000000000', true),

('Training Reminder', 'reminder', 'education', '📚 Don''t forget! You have a training session scheduled for {{training_name}} on {{date}} at {{time}}. This is an important step in your development journey.', '["training_name", "date", "time"]', '00000000-0000-0000-0000-000000000000', true),

('Monthly Goal Update', 'motivation', 'goals', '💪 We''re halfway through the month! How are you progressing toward your {{goal_type}} goal? Remember, every step forward counts. You''ve got this!', '["goal_type"]', '00000000-0000-0000-0000-000000000000', true),

('Team Announcement', 'announcement', 'general', '📢 Important Update: {{announcement_title}}\n\n{{announcement_content}}\n\nPlease review and let us know if you have any questions.', '["announcement_title", "announcement_content"]', '00000000-0000-0000-0000-000000000000', true);
