-- Subscription Management Database Schema (Fixed Version)
...
-- Create subscriptions table with correct column names
...
CREATE INDEX idx_subscriptions_is_executive_account ON subscriptions(is_executive_account);
